...
public class MainFra extends JFrame {
    ...
    public MainFra(){
        this.setTitle("tlj");
        this.setBounds(100,100,710,520);
        //美化UI
        try {
...
//            e.printStackTrace();
    ...
    public void init(){
        JMenu().add(new JmenuComponent().getMenu());
        ...
        addOnBounds(this,NumberLabel(),rowAddSpacing(QQNameLabel(),10),columnAddSpacing(TypingAndWatching(),10),120,40);
        addOnBounds(this,NumberRecordLabel(),rowAddSpacing(NumberLabel(),10),columnAddSpacing(TypingAndWatching(),10),120,40);
