...
public class test {
    public static void main(String[] args) {
        ...
        BetterTyping betterTyping = BetterTypingSingleton.getInstance();
        long start = System.currentTimeMillis();
        betterTyping.changecolortip(stringBuilder.toString());
        System.out.println(stringBuilder.length()+"长度的词提与最短编码计算时间:"+(System.currentTimeMillis()-start));
        betterTyping.compalllength();
        System.out.println("理论编码长度："+betterTyping.getDingalllength());
        System.out.println("理论码长："+betterTyping.getDingKeylength());
//        System.out.println("理论编码："+betterTyping.getDingShowStr());
    }
}
