    ...
    public static RobotHistory getGradeMap(String event){
        ...
        try {
            ...
            if(keyAccuracyStart != -1){
                ...
                robotHistory.setKeyAccuracy(-1.0);
            }
            if (repeatNumStart != -1) {
